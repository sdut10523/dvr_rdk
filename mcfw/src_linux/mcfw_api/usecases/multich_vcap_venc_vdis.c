...
Void MultiCh_createVcapVencVdis()
{
    ...
    for(vipInstId=0; vipInstId<capturePrm.numVipInst; vipInstId++)
    {
        ...
        pCaptureInstPrm->vipInstId          = SYSTEM_CAPTURE_INST_VIP1_PORTB-vipInstId;//SYSTEM_CAPTURE_INST_VIP0_PORTA+vipInstId;
    ...
    for(i=0; i<MAX_DEI_LINK; i++)
    {
        ...
        deiPrm[i].outScaleFactor[DEI_LINK_OUT_QUE_VIP_SC_SECONDARY_OUT].ratio.widthRatio.denominator = 1;
        deiPrm[i].outScaleFactor[DEI_LINK_OUT_QUE_VIP_SC_SECONDARY_OUT].ratio.heightRatio.numerator = 1;
        deiPrm[i].outScaleFactor[DEI_LINK_OUT_QUE_VIP_SC_SECONDARY_OUT].ratio.heightRatio.denominator = 1;
        ...
        mergePrm[DEI_SC_D1_MERGE_LINK_IDX].numInQue                     = MAX_DEI_LINK;
...
*/
    ...
    {
        dspAlgPrm.outQueParams.nextLink     = SYSTEM_LINK_ID_INVALID;//nullId;
    }
