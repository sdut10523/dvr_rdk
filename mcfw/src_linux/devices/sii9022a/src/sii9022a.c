...
/*add by cwh for sii9134*/
static Int32 Device_sii9134_init(Device_Sii9022aObj *pSiiObj)
{
   	Int32 retVal;
   	UInt8 reg_value[20], reg_addr[20];
    	UInt32 num_regs;

    	num_regs = 0;
    	reg_addr[num_regs] = 0x8;
    	reg_value[num_regs] =0x35;
   	num_regs++;

	reg_addr[num_regs] =  0x40;
	reg_value[num_regs] = 0x6e;
	num_regs++;

	reg_addr[num_regs] = 0x41;
	reg_value[num_regs] = 0x0;
	num_regs++;

	reg_addr[num_regs] = 0x44;
	reg_value[num_regs] =0x28;
	num_regs++;

	reg_addr[num_regs] = 0x45;
	reg_value[num_regs] = 0x0;
	num_regs++;

	reg_addr[num_regs] = 0x46;
	reg_value[num_regs] = 0x5;
	num_regs++;

	reg_addr[num_regs] = 0x47;
	reg_value[num_regs] =0x5;
	num_regs++;

	reg_addr[num_regs] = 0x48;
	reg_value[num_regs] = 0x30;
	num_regs++;

	reg_addr[num_regs] = 0x4a;
	reg_value[num_regs] = 0xd;
	num_regs++;
