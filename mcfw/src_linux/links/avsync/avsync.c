...
Int32 AVSYNC_Control(UInt8 cmd,  Void *pPrm)
{
    ...
    switch (cmd)
    {
        ...
        default:
            printf(" *** Invalid command was called *** \n");
    }
    AVSYNC_ReleaseSharedDataStructure(key);
...
{
    printf ("VIDEO ==> Dq [%6d] Ren [%6d] Rep [%6d], Skip [%6d], Inv [%6d], LstPTS %10lld\n",
    ...
    /*printf ("AUDIO ==> Dq [%6d] Ren [%6d] Rep [%6d], Skip [%6d], Inv [%6d], LstPTS %10d\n",
