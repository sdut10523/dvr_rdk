...
#define SYSTEM_LINK_COMMON_LINKS_MAX_ID (SYSTEM_LINK_ID_IPC_BITS_IN_1)
...
//#define SYSTEM_VPSS_LINK_ID_NULL_SRC_3      VPSS_LINK(SYSTEM_LINK_ID_NULL_SRC_3  )
...
#define SYSTEM_LINK_ID_CAPTURE              VPSS_LINK(32) 
...
#define SYSTEM_LINK_ID_NSF_0                VPSS_LINK(33)
#define SYSTEM_LINK_ID_NSF_1                VPSS_LINK(34)

#define SYSTEM_LINK_ID_DEI_HQ_0             VPSS_LINK(35)
#define SYSTEM_LINK_ID_DEI_HQ_1             VPSS_LINK(36)

#define SYSTEM_LINK_ID_DEI_0                VPSS_LINK(37)
#define SYSTEM_LINK_ID_DEI_1                VPSS_LINK(38)

#define SYSTEM_LINK_ID_DISPLAY_0            VPSS_LINK(39)
#define SYSTEM_LINK_ID_DISPLAY_1            VPSS_LINK(40)
#define SYSTEM_LINK_ID_DISPLAY_2            VPSS_LINK(41)


#define SYSTEM_LINK_ID_GRPX_0               VPSS_LINK(42)
#define SYSTEM_LINK_ID_GRPX_1               VPSS_LINK(43)
#define SYSTEM_LINK_ID_GRPX_2               VPSS_LINK(44)

#define SYSTEM_LINK_ID_SW_MS_DEI_0          VPSS_LINK(45)
#define SYSTEM_LINK_ID_SW_MS_DEI_HQ_0       VPSS_LINK(46)

#define SYSTEM_LINK_ID_SW_MS_SC_0           VPSS_LINK(47)
#define SYSTEM_LINK_ID_SW_MS_SC_1           VPSS_LINK(48)
#define SYSTEM_LINK_ID_SW_MS_SC_2           VPSS_LINK(49)
#define SYSTEM_LINK_ID_SW_MS_SC_3           VPSS_LINK(50)

#define SYSTEM_LINK_ID_SW_MS_MULTI_INST_0   VPSS_LINK(51)
#define SYSTEM_LINK_ID_SW_MS_MULTI_INST_1   VPSS_LINK(52)
#define SYSTEM_LINK_ID_SW_MS_MULTI_INST_2   VPSS_LINK(53)

#define SYSTEM_LINK_ID_SCLR_INST_0          VPSS_LINK(55)
#define SYSTEM_LINK_ID_SCLR_INST_1          VPSS_LINK(56)
...
#define SYSTEM_VIDEO_LINK_ID_NULL_3         VIDEO_LINK(SYSTEM_LINK_ID_NULL_3      )
...
//#define SYSTEM_VIDEO_LINK_ID_NULL_SRC_3     VIDEO_LINK(SYSTEM_LINK_ID_NULL_SRC_3  )
...
#define SYSTEM_LINK_ID_VENC_0               VIDEO_LINK(32)
#if (SYSTEM_GET_LINK_ID(SYSTEM_LINK_ID_VENC_0) < (SYSTEM_LINK_COMMON_LINKS_MAX_ID + 1))
#error "System Core Private Link ID overlaps with common linkID. Update Core private link ID"
#endif
#define SYSTEM_LINK_ID_VENC_1               VIDEO_LINK(33)
...
#define SYSTEM_LINK_ID_VDEC_0               VIDEO_LINK(34)
#define SYSTEM_LINK_ID_VDEC_1               VIDEO_LINK(35)
...
#define SYSTEM_LINK_ID_ALG_0               DSP_LINK(32)
#if (SYSTEM_GET_LINK_ID(SYSTEM_LINK_ID_ALG_0) < (SYSTEM_LINK_COMMON_LINKS_MAX_ID + 1))
#error "System Core Private Link ID overlaps with common linkID. Update Core private link ID"
#endif
#define SYSTEM_LINK_ID_ALG_1               DSP_LINK(33)
