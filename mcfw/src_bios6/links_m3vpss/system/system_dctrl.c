...
Int32 System_displayCtrlInit(VDIS_PARAMS_S * pPrm)
{
    ...
    gSystem_dctrlTriDisplayConfig.vencInfo.tiedVencs = pPrm->tiedDevicesMask;
#endif
...
#ifdef TI_816X_BUILD
//  if(pPrm->deviceParams[SYSTEM_DC_VENC_HDMI].resolution == VSYS_STD_1080P_60)
//      gSystem_objVpss.vpllCfg[SYSTEM_VPLL_OUTPUT_VENC_D].outputClk =
//                                System_getClk(pPrm->deviceParams[SYSTEM_DC_VENC_HDMI].resolution) * 2;
