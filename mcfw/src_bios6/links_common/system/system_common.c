...
#ifdef SYSTEM_DEBUG
    Vps_printf
        (" %d: SYSTEM  : Heap Free Space (System = %d bytes, SR0 = %d bytes, FrmBuf = %d bytes, 
         BitBuf = %d bytes, Mbx = %d msgs) \r\n",
         Utils_getCurTimeInMsec(), Utils_memGetSystemHeapFreeSpace(),
...
int System_enumAssertCheck()
{
    ...
    UTILS_COMPILETIME_ASSERT(SYSTEM_DF_MAX == FVID2_DF_MAX);
    ...
    UTILS_COMPILETIME_ASSERT(SYSTEM_STD_MAX == FVID2_STD_MAX);
