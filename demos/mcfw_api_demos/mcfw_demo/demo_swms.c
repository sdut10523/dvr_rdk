          ...
          VDIS_MOSAIC_S * vdMosaicParam, Bool forceLowCostScaling, UInt32 demoType, UInt32 resolution)
{
    ...
    if(layoutId == DEMO_LAYOUT_MODE_4CH_4CH)
    {
        ...
        for(row=0; row<2; row++)
        {
            for(col=0; col<2; col++)
            {
                ...
                vdMosaicParam->winList[winId].width = VsysUtils_align((outWidth*2)/5, widthAlign);
                vdMosaicParam->winList[winId].height = VsysUtils_align(outHeight/2, heightAlign);
    ...
    if(layoutId == DEMO_LAYOUT_MODE_6CH)
    {
        ...
        vdMosaicParam->winList[winId].width = VsysUtils_align((outWidth*2)/3, widthAlign);
        vdMosaicParam->winList[winId].height = VsysUtils_align((outHeight*2)/3, heightAlign);
        vdMosaicParam->winList[winId].start_X = 0;
        vdMosaicParam->winList[winId].start_Y = 0;
        ...
        for(row=0; row<2; row++)
        {
            ...
            vdMosaicParam->winList[winId].width = VsysUtils_align(vdMosaicParam->winList[0].width/2, widthAlign);
            vdMosaicParam->winList[winId].height = VsysUtils_align(vdMosaicParam->winList[0].height/2, heightAlign);
    ...
    if(layoutId == DEMO_LAYOUT_MODE_7CH_1CH)
    {
        ...
        vdMosaicParam->winList[winId].width = VsysUtils_align((outWidth)/4, widthAlign)*3;
        vdMosaicParam->winList[winId].height = VsysUtils_align((outHeight)/4, heightAlign)*3;
        vdMosaicParam->winList[winId].start_X = 0;
        vdMosaicParam->winList[winId].start_Y = 0;
        ...
        for(row=0; row<3; row++)
        {
            ...
            vdMosaicParam->winList[winId].width = VsysUtils_align(
                                outWidth - vdMosaicParam->winList[0].width,
                                widthAlign);
            vdMosaicParam->winList[winId].height = VsysUtils_align(
        ...
        for(col=0; col<4; col++)
        {
            ...
            vdMosaicParam->winList[winId].width = VsysUtils_align(outWidth / 4, widthAlign);
            vdMosaicParam->winList[winId].height = VsysUtils_align(
    ...
    if(layoutId == DEMO_LAYOUT_MODE_2CH_PIP)
    {
        ...
        for(col=0; col<2; col++)
        {
            ...
            vdMosaicParam->winList[winId].width = VsysUtils_align(outWidth/4, widthAlign);
            vdMosaicParam->winList[winId].height = VsysUtils_align(outHeight/4, heightAlign);

            if(col==0)
            {
                vdMosaicParam->winList[winId].start_X = VsysUtils_align(outWidth/20, widthAlign);
            }
            else
            {
                vdMosaicParam->winList[winId].start_X = VsysUtils_align(
                    outWidth - vdMosaicParam->winList[winId].width - outWidth/20,
                    widthAlign);
            }

            vdMosaicParam->winList[winId].start_Y = VsysUtils_align(
